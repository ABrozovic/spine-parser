 ...
 * @public
 */
export declare interface IVertexAttachment<Slot extends ISlot = ISlot>
  extends IAttachment {
  id: number
 ...
 * @public
 * */
export declare class SkeletonBoundsBase<
...
> {
  ...
  aabbIntersectsSkeleton(
    bounds: SkeletonBoundsBase<BoundingBoxAttachment>
  ): boolean
 ...
 */
export declare abstract class SpineBase<
...
export declare class SpineMesh
  extends SimpleMesh
  implements ISpineDisplayObject
{
  region?: TextureRegion
  attachment?: IAttachment
  constructor(
